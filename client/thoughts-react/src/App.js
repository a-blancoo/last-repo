  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <button className="w3-button w3-light-blue w3-border w3-round" onClick={this.createThought}>Create Thought</button>
        <button className="w3-button w3-light-blue w3-border w3-round" onClick={this.deleteThoughts}>Delete Thoughts</button>
        <button className="w3-button w3-light-blue w3-border w3-round" onClick={this.seedThoughts}>Seed Thoughts</button>
